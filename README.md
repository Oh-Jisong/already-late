...
<p align="center">
  누르지 말랬잖아 버튼을 누를수록 화면이 점점 망가지는 어이없는 웹사이트 (도망 버튼 + 로그 + glitch + 망함지수)
</p>
...
## Future Improvements
- [ ] 엔딩 단계에서 “망함 보고서” 자동 생성 (무의미하게 진지한 분석)
- [ ] 클릭/회피 성공 횟수 기반 점수화 & 랭킹(로컬스토리지)
- [ ] BGM/효과음(단계별 음성/비프음)
- [ ] 모바일 최적화(터치 도망 로직/뷰포트 대응)
- [ ] 다양한 엔딩 분기(선택지/확률 기반)
- [ ] AI 기반 프로젝트